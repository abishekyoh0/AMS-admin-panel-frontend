        ...
        <div className="mb-8">
            <div className="grid lg:grid-cols-3 gap-6">
                ...
                <div className="bg-[#FFFFFF0D] border border-[#FFFFFF33] rounded-2xl p-5">
                    ...
                    <div className="flex flex-col items-center">
                        <div style={{ position: "relative", width: 240, height: 240 }}>
                            ...
                            <div className="flex flex-col items-center justify-center"
                                ...
                                <h1 style={{ fontSize: 64, fontWeight: 700, background: "linear-gradient(90deg,#22d3ee,#a78bfa)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                                    {overall}%
                                </h1>
                                <div className={`px-3 py-1 mt-1 rounded-2xl ${FONTSIZE[14]} ${FONTWEIGHT[700]}`}
                    ...
                    <div style={{ height: 2, background: "#ffffff22", margin: "25px 0" }} />

                    <div className="space-y-4">
                        {PERFORMANCE.map((p, i) => (
                            <div key={i}>
                                <div className={`flex justify-between mb-1 ${FONTSIZE[14]} ${FONTWEIGHT[700]}`}>
                                    <span style={{ color: COLORS.secoundy_gray }}>{p.label}</span>
                                    <span>{p.value}%</span>
                                </div>
                                <div style={{ width: "100%", height: 6, background: "#ffffff1a", borderRadius: 10 }}>
                                    <div style={{ width: `${p.value}%`, height: 6, background: p.color, borderRadius: 10 }} />
                                </div>
                            </div>
                        ))}
                    </div>

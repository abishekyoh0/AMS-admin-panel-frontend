...
const AccessRequestModal: React.FC<Props> = ({ isOpen, onClose, data }) => {
      ...
      >
        ...
        <div className="overflow-y-auto p-4 sm:p-6 lg:p-8 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            ...
            <button
              onClick={onClose}
              className="self-end sm:self-start text-gray-400 hover:text-white text-xl font-bold transition cursor-pointer"
            >
              ✕
            </button>
          </div>

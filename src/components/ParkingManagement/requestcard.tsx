...
const SAMPLE_4W_SLOTS = [
  ...
  { id: "B2-A-105", basement: "Basement 2", occupied: false },
  {
    ...
    occupant: {
      name: "Michael Smith",
      unit: "Unit B-202",
      vehicle: "Toyota Camry (NY 2222 BB)",
    },
  },
...
export default function RequestCard({
  ...
  return (
        ...
        ${
          ...
          <div className="flex-1">
            <div className="flex flex-wrap items-center gap-2">
              <h3
                className={`text-white font-semibold text-lg ${FONTSIZE[20]}`}
                style={{
              ...
              <span
                className={`inline-flex items-center justify-center px-3 h-7 text-xs rounded-[10px] border-[1.75px] border-[#F0B1004D] bg-[#F0B10033] text-[#FDC700] ${FONTSIZE[12]}`}
              ...
              <span
                className={`inline-flex items-center justify-center px-3 h-6 text-xs rounded-[10px] bg-[#FFFFFF1A] text-[#99A1AF] ${FONTSIZE[12]}`}
    ...
    "
          >
            <span
              className={`truncate ${FONTSIZE[14]}`}
              style={{ fontWeight: WEIGHT.four, color: COLORS.grey }}
            >
              Request ID:
              <span
            ...
            {slot && (
              <span
                className={`lg:text-right text-purple-400 font-medium truncate ${FONTSIZE[14]}`}
                style={{ fontWeight: WEIGHT.six }}
              >
                <span
                  className={`text-gray-300 ${FONTSIZE[14]}`}

...
const logs: LogItem[] = [
  {
    ...
    slot: "B1-M-025",
    description:
      "Assigned to Emily Rodriguez (C-108) for Yamaha R15 V4",
  ...
  },
  {
    ...
    slot: "B2-A-104",
    description:
      "Assigned to Sarah Johnson (A-304) for Honda Civic 2023",
    admin: "Admin - John Anderson",
  ...
  },
  {
    ...
    slot: "B1-M-030",
    description:
      "Reassigned from Jane Smith to John Doe (A-101)",
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#000000CC] px-3 sm:px-4">
      ...
      <div
        className="
          ...
          rounded-2xl
          p-4 sm:p-6
          bg-linear-to-br from-[#0F172B] to-[#101828]
        ...
        <div className="flex flex-col items-center mb-5 sm:mb-6 text-center">
          <div
            className="
              ...
              rounded-full
              bg-linear-to-br from-[#00B8DB33] to-[#2B7FFF33]
              border border-[#00D3F34D]
          ...
          {logs.map((log) => (
            ...
            >
              <div className="flex gap-3">
                ...
                >
                  <img
                    src={log.type === "assigned" ? assignedIcon : reassignedIcon}
                    alt="status icon"

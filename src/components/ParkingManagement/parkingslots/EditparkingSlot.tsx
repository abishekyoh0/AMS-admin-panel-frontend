...
import Editicon from "../../../assets/parking/editprakingicon.png";
import editbutton from "../../../assets/parking/editprakingnbutton.png";
...
export default function EditparkingSlot({ onClose, slot }: Props) {
  const [vehicleType, setVehicleType] = useState<VehicleType>(slot.type);
  const [slotNumber, setSlotNumber] = useState(slot.id);
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="w-full sm:w-[90%] md:w-[600px] lg:w-[700px] max-h-[90vh] overflow-y-auto bg-gradient-to-br from-[#0F172B] to-[#101828] border border-white/10 rounded-2xl p-5 sm:p-6 md:p-8 shadow-2xl relative ">
        <div className="text-center mb-6">
          <div className="w-19 h-19 mx-auto mb-3 rounded-full flex items-center justify-center bg-gradient-to-br from-[#2B7FFF33] to-[#00B8DB33] border border-[#51A2FF4D] ">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full mt-1 bg-[#FFFFFF0D] border border-[#FFFFFF1A] rounded-lg px-4 py-2 text-sm text-white"
            >

...
const UserManagement = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#0f172a] to-[#1e293b] text-white p-4 sm:p-6">
            ...
            {/* Header */}
            <div className="mb-6">
                <h1 style={{...FONTWEIGHT[700]}} className={` ${FONTSIZE[36]}text-2xl sm:text-3xl font-bold`}>User Management</h1>
                <p
...
const colorStyles = {
    lightblue:
        "bg-[#2B7FFF33] border border-[#51A2FF4D] text-[#FFFFFF]",
    green:
        "bg-[#00C95033] border border-[#05DF724D] text-[#FFFFFF]",
    brown:
        "bg-[#FF690033] border border-[#FF89044D] text-[#FFFFFF]",
    violet:
        "bg-[#AD46FF33] backdrop-blur-md border border-[#C27AFF4D] text-[#FFFFFF]",
    blue:
        "bg-[#00B8DB33] backdrop-blur-md border border-[#00D3F34D] text-[#FFFFFF]",
};
    ...
    >
        <X size={18} />
                ...
                <div className="flex justify-end gap-3">
                    ...
                    <button
                        onClick={onConfirm}
                        className={`px-4 py-2 rounded-xl text-sm ${isActive

      ...
      <div className="flex flex-col lg:flex-row lg:items-center gap-4 mb-6">
        ...
        <div className="flex gap-3 shrink-0 ">
          <button
            ...
            className="px-10 py-3 rounded-full bg-gradient-to-r from-[#AD46FF] to-[#E60076] text-black text-sm transition duration-300 cursor-pointer"
          >
            Add New User
          </button>
        ...
        <div className="flex-1 lg:ml-auto">
          <input
            ...
            className="w-full px-6 py-3 rounded-full bg-[#1e293b] border border-gray-600 focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm"
            value={search}

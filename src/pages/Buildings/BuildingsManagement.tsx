...
export default function BuildingsManagement() {
  ...
  return (
    <div>
      <h1
        className={`text-3xl font-bold mb-1 ${FONTSIZE[36]}`}
        style={{ fontWeight: WEIGHT.seven, color: COLORS.primary_white }}
      >
        Building Management
      </h1>
      <p
        className={`opacity-70 mb-6 ${FONTSIZE[16]}`}
      ...
      <button
        ...
        className="mb-8 flex cursor-pointer items-center gap-2 px-6 py-3 rounded-full font-semibold text-white shadow-lg  transition bg-linear-to-r from-[#2B7FFF] to-[#0092B8]"
      >

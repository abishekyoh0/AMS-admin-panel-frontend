      ...
      <div className="flex justify-between items-center mb-8 flex-wrap gap-4">
        <div>
          ...
          <div style={{ marginBottom: 20 }}>
            <span
              className={`flex w-fit gap-1 items-center px-3 py-1 mb-2 rounded-full ${FONTSIZE[12]} ${FONTWEIGHT[700]}`}
              style={{ background: "#00c95122", color: "#22c55e" }}
            >
              <img src={Green} alt="" className={`w-2 h-2`} /> All Systems
              Operational
            </span>
        ...
        <div className="flex gap-3">
          ...
          >
            <img
              src={Add}
              alt=""
              className={`w-5 h-5 ${FONTSIZE[16]} ${FONTWEIGHT[700]}`}
            />{" "}
            Quick Add
          </button>
          <button
            className="flex items-center gap-2 bg-linear-to-r from-[#AD46FF] to-[#E60076] px-4 py-2 rounded-2xl cursor-pointer"
            style={{
              boxShadow:
